...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://denis-andia.lovable.app/__l5e/assets-v1/2a5aa545-685c-490f-abef-20f480edc1bb/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://denis-andia.lovable.app/__l5e/assets-v1/2a5aa545-685c-490f-abef-20f480edc1bb/og-image.png" },
    ],
  }),
  component: Home,
});
    ...
    <Layout transparentHeader>
      ...
      <section id="trabalho" className="relative bg-background overflow-hidden">
        <div className="w-full px-2 md:px-6 pt-16 md:pt-24 pb-6 md:pb-8">
          ...
          <div className="relative mt-2 md:mt-[-4rem] w-full flex flex-col md:block overflow-hidden md:overflow-visible min-h-[450px] md:min-h-0">
            {/* Mapa: No mobile ele fica MUITO grande, width > 100% e centralizado com overflow lateral */}
            <div className="relative z-0 w-[140%] left-[-20%] md:w-full md:left-0 scale-[1.2] md:scale-[1.35] lg:scale-[1.55] transition-transform duration-500 order-1 md:order-none mt-8 md:mt-0">
              <RegionMap mapOnly />
            </div>

            {/* Denis: No mobile à esquerda, menor e sobreposto ao mapa */}
            <div className="absolute z-10 bottom-[5%] left-[-10%] md:bottom-[20%] lg:bottom-[25%] md:left-[2%] w-[65%] md:w-[35%] lg:w-[28%] max-w-[580px] pointer-events-none md:pointer-events-auto">
              <img
          ...
          <div className="relative z-20 mt-6 flex flex-wrap gap-3 justify-center lg:justify-start lg:pl-6">
            <Legend color="var(--brand-yellow)" label="RMC — Região Metropolitana de Campinas" />
