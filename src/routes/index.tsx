      ...
      <section id="trabalho" className="relative bg-background overflow-hidden">
        <div className="w-full px-2 md:px-6 pt-16 md:pt-24 pb-6 md:pb-8">
          ...
          <div className="relative mt-2 md:mt-[-4rem] w-full flex flex-col md:block">
            <div className="relative z-0 w-full md:scale-125 lg:scale-135 transition-transform duration-500 order-1 md:order-none">
              <RegionMap mapOnly />
            </div>

            <div className="relative md:absolute z-10 mt-[-10%] sm:mt-[-15%] md:mt-0 md:bottom-[20%] lg:bottom-[25%] left-0 md:left-[2%] w-[70%] md:w-[35%] lg:w-[28%] max-w-[580px] pointer-events-none order-2 md:order-none mx-auto md:mx-0">
              <img
