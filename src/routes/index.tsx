      ...
      <section id="trabalho" className="relative bg-background overflow-hidden">
        <div className="w-full px-2 md:px-6 pt-16 md:pt-24 pb-6 md:pb-8">
          ...
          <div className="relative mt-2 md:mt-[-4rem] w-full flex flex-col md:block overflow-hidden md:overflow-visible min-h-[500px] md:min-h-0">
            ...
            <div className="relative z-0 w-[110%] left-[-5%] md:w-full md:left-0 scale-[1.05] md:scale-[1.35] lg:scale-[1.45] transition-transform duration-500 order-1 md:order-none mt-8 md:mt-0">
              <RegionMap mapOnly />
            </div>

            {/* Denis: No mobile à esquerda, grande e sobreposto ao mapa */}
            <div className="absolute z-10 bottom-[15%] left-[-5%] md:bottom-[20%] lg:bottom-[25%] md:left-[2%] w-[45%] md:w-[35%] lg:w-[28%] max-w-[580px] pointer-events-none md:pointer-events-auto">
              <img
